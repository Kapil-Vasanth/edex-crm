          ...
          <div className="statistical-grid">
            <div className="statistical-item">
              <span className="statistical-label arrow-mark">
                What was (or will be) applicant's main activity on the 1st
                October in the year before the start of study?
              </span>
              <span className="statistical-value">
                Waged or salaried worker
              </span>
            </div>

            <div className="statistical-item">
              <span className="statistical-label arrow-mark">
                How did the applicant hear about AUT University?
              </span>
              <span className="statistical-value">
            ...
            <div className="statistical-item">
              <span className="statistical-label arrow-mark">
                Has at least one of the applicant's parents (or a primary
                caregiver) studied at university?
              </span>
            ...
            <div className="statistical-item">
              <span className="statistical-label arrow-mark">
                Do you describe yourself as Deaf, disabled, neurodivergent,
                targets whaikaha Māori, or living with a long-term physical or
